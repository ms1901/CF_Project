...
public class AmazonDataProcessing {
    public static final String PATH = "reviews_Musical_Instruments_5.json";
    ...
    public static final double TRAIN_RATIO = 0.8;//TRAINING TEST ratio
    ...
    public static void main(String[] args) throws IOException {
        AmazonDataProcessing amazonFileExtraction = new AmazonDataProcessing("/Users/atul/Desktop/CF/Project_End/CARP/");
        ...
        Map<String, Double> sortedMap = amazonFileExtraction.sortByValueDesc(map);
        ...
        Set<String> retainWords = IOUTils.readFile2Set(amazonFileExtraction.path_prefix + "retainWordVoca.out");
        lines = amazonFileExtraction.retainFinalWord("CleanVersion.out", retainWords);
        IOUTils.writeFile(lines, amazonFileExtraction.path_prefix+"FinalCleanVersion.out");
//        List<String> lines = IOUTil.readFile2List(amazonFileExtraction.path_prefix + "FinalCleanVersion.out");
        ...
        IOUTils.writeStr2IntMap2File(amazonFileExtraction.path_prefix + "user2IdMapping.out", user2IdMap);
        IOUTils.writeStr2IntMap2File(amazonFileExtraction.path_prefix + "item2IdMapping.out", item2IdMap);
        ...
        amazonFileExtraction.getTrainTestSet(TRAIN_RATIO, user2IdMap.size(), item2IdMap.size(), "TrainInteraction.out", "TestInteraction.out", user2item2rateMap, item2user2rateMap);
        ...
        Set<String> vals = IOUTils.getTrainSet(amazonFileExtraction.path_prefix + "ValInteraction.out", SEPARATOR[0]);
        tests.addAll(vals);
        ...
        IOUTils.writeFile2Label(amazonFileExtraction.path_prefix + "UserReviews.out", user2Reviews);
        ...
        IOUTils.writeFile2Label(amazonFileExtraction.path_prefix + "ItemReviews.out", item2Reviews);
